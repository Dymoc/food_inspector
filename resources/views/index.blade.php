                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        data.forEach(e => {
                            ...
                            <div class="product-card__two">
                                <div class="product-card__two-image">
                                    <img src="${e.img}" alt="фото рецепта">
                                    <div class="product-card__two-image-content">
                                        <a href="#${ e.id }"><i class="organik-icon-visibility"></i></a>
                                        <a href="#"><i class="organik-icon-heart"></i></a>
                                    </div><!-- /.product-card__two-image-content -->
                                </div><!-- /.product-card__two-image -->
                                <div class="product-card__two-content">
                                    <h3><a href="#${ e.id }">${ e.name }</a></h3>

                                    <div class="row">
                                        <div class="col-md-12 properties"><img
                                                src="{{ asset('/images/calculator/time.svg') }}" /><span>${ e.cooking_time }
                                                минут</span></div>
                                        <div class="col-md-12 properties"><img
                                                src="{{ asset('/images/calculator/chart.svg') }}" /><span>395 Ккал</span>
                                        </div>
                        ...
                        let alert = `<div class="alert alert-success alert-dismissible fade show" role="alert">
                                По вашему запросу нашлось ${data.length} рецептов
                                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>`;
                        $('.search-tab-pane').append(alert);
